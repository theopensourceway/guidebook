...
This chapter also described multiple reward models and discussed benefits of drawbacks of each.
The more reward models a community can feature, the greater its chances of channeling enthusiastic participation from contributors with various backgrounds, motives, and talents.
