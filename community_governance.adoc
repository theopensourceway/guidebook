...
***BKP: That's a lot more than a few.
Trim to three? ^^^ ***
...
***BKP: "Apache" is not a single project.
Please correct.
^^^ ***
...
What fewer projects put into their leadership role documents is the other parts: the powers and limitations of the leaders, their duties, and how people leave the role (voluntary or otherwise).
...
***BKP: Please get these two lists above aligned with numbers.
I see eight items above and you outline six things.
^^^VVV ***
