...
In the days before open source, measuring the success of a software project was often defined in strictly financial terms. How many boxes--yes, boxes--of software did a company sell? That revenue was offset by the cost of support, authoring, and distribution (again, boxes), and voila! The profit was the measure of success.
...
* Want to know if your community is healthy
* Are seeking data that can demonstrate successes and failures
* Need more contributors in your project
