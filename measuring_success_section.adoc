...
In the days before open source, measuring the success of a software project was often defined in strictly financial terms.
...
For open source projects, success is not just measured in terms of commercial or consumptiove success.
...
Now, though, one can easily dive into the data shown by open development, and use  that data to derive quantiative information about a project's health.
It will be these concepts that this section will explore.
