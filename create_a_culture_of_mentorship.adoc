...
// Authors: Karsten Wade <kwade@redhat.com>, Guedis Cardenas <guedis@palante.co>, Ray Paik <ray@cube.dev>, Bryan Behrenshausen <bbehrens@redhat.com>
// Updated: 2020-12-10
// Versions: 2.0
// Status: DRAFT
...
Mentorship means different things to people. The interpretations vary based on the individual, situation, context, culture, and more. For example, to some, mentorship is a formal activity with a schedule and agenda. To others, mentorship is an informal process amongst peers -- it can even be a one time conversation. If you ask people their definition of mentorship, you will most likely get wide-ranging responses.
...
In summary, it is beneficial to acknowledge that mentorship can go beyond traditionally beyond providing guidance. There are various ways to mentor and in doing so, it provides valuable and lasting benefits for the contributors, open source project, and community.
