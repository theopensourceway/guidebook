...
The same GitHub survey which found that 1 in 5 open source contributors leave due to bad behavior also found that incomplete/confusing documentation was https://opensourcesurvey.org/2017/[the biggest challenge].
...
As a result, it's hard for project veterans to https://opensource.com/article/20/4/documentation[read their projects' docs].

Imagine how outsiders feel.
