...
// Authors: Bryan Behrenshausen <bbehrens@redhat.com>, Dave Neary <dneary@redhat.com>, Karsten Wade <kwade@redhat.coim>
// Updated: 2020-12-16
// Version: 2.0
// Status: DRAFT
...
This chapter is named _Community 101_ in reference to a way of number courses in some universities.
...
This might be a community of hammer dulcimer players who have an annual gathering to share about the art and practice of being a hammer dulcimer player.
These might be skateboarders, gathering every week at the park to learn and practice new tricks.

For you and your organization to consider forming an open source software community, you must first be willing to form and be the caretakers for any other sort of community.
Is doing so something that can match your vision?
...
Their reasons for forming any kind of community may be wildly different, or unexpectedtly aligned.

A feature of communities of practice that is appropriate for open source software communities is how it can truly draw together people and organizations form wildly different worlds.
The key is when their common interests cross (the practice) and is there to tolerance for sharing and growing together (community).
...
You might already have or are planning a new technology, and open source is a way to get like-minded collaborators.
...
If there is no legal barrier to starting a project that considers all of these elements from the beginning, why not start one?
