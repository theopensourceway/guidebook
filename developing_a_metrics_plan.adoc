...
=== *The CHAOSS project* 
Not surprisingly, there's an open source project that is focused on community metrics. (https://chaoss.community) develops metrics definition and sample implementation for open source communities. 
