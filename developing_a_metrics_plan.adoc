...
. Making comparisons between open source communities based on a few metrics: Sometime you hear things like "Project A had more than 5,000 people in their last  conference" or "Project B has 1,000 contributors". No two open source projects are alike as you may be in different industries, in different stages of the life cycle, or have a different scope. Before you think about wanting 1,000 contributors in your community, you may need to ask basic questions like do we really need 1,000 people for project's scope?  Not making apples-to-apples comparision. 
. Gaming contribution metrics. 
. Too much focus on code contributions: It may be because there are more tools available to capture code activities, but there's a tendency to focus mostly on code contributions in open source communities. However, it is important to remember other valuable contributions that community members make such as answering questions on forums, triaging issues, maintaining wiki pages, etc. There should be an effort to ensure that community metrics reflect variety of contributions (both code and non-code) in the community. 
